...
---
# Note
I won't really be explaining everything... but feel free to ask me questions on discord (SEWsam#4092).  
_I'm also pretty close to finishing a small python program that will dump the game to an unencrypted location, and patch the existing modding tools to work properly; **doing everything below for you**_
...
This is where I have very little knowledge, yet somehow managed to get this working within just a day.  
### The solution:
...
### My Process
I don't have _any_ previous experience with low-level programming. But, after some quick research, I learned about [Ghidra](https://ghidra-sre.org), and went in blindly.  
